window.addEventListener('load', () => {
    ...
    setTimeout(() => {
        ...
        if (uiLoading) { uiLoading.innerHTML = 'STATUS: <span style="color: var(--primary);">ONLINE</span>'; }
...
window.addEventListener('scroll', () => {
    ...
    if (scrollTopBtn) {
        if (pageYOffset > 300) scrollTopBtn.classList.add("show-btn");
...
if (contactForm && successMsg) {
    contactForm.addEventListener('submit', function (e) {
        ...
        successMsg.innerText = "Sending Message...";
        successMsg.style.color = "var(--text-muted)";
        ...
        fetch('https://api.web3forms.com/submit', { method: 'POST', body: formData })
            ...
            .catch(() => {
                successMsg.innerText = "Network Error!";
                successMsg.style.color = "#ff3366";
            })
            .then(() => {
                setTimeout(() => { successMsg.classList.remove('show-msg'); }, 4000);
            });
    });
}